...
const (
	...
	// default model names
	defaultGoogleAIModel                 = `gemini-3.5-flash`
	defaultGoogleAIImageGenerationModel  = `gemini-3.1-flash-lite-image`
	defaultGoogleAIVideoGenerationModel  = `veo-3.1-lite-generate-preview`
